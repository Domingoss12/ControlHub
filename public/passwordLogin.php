...
<body class="bg-[url('assets/Images/Background.svg')] bg-repeat">
    ...
    <div class="<?php echo $hiddenMessage; ?> fixed top-32 md:top-10 left-1/2 transform -translate-x-1/2 z-50" id="toast-warning" role="alert">
        <div class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800">
            ...
            <div class="ms-3 text-sm px-2 font-normal">Palavra-passe incorreta!</div>
    ...
    <div class="hidden md:flex items-center justify-center h-screen">
        <div class="w-2/6 pb-10 pt-2 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-2xl">
            ...
            <div class="text-center my-3">
                <h6 class="text-md font-normal text-gray-900 dark:text-white">Nome de utilizador: <b>Master</b></h6>
            </div>
            <div class="h-3/4 flex items-center justify-center">
                <form class="w-4/5" method="post" action="../src/function/authUserPassword.php">
                    <div class="mb-5">
                    ...
                    <div class="w-full flex items-center justify-center mt-4">
                        <button type="submit" class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm w-15 sm:w-auto px-5 py-2.5 text-center dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Iniciar Sessão</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="flex md:hidden items-center justify-center h-screen ">
        <div class="w-full h-full bg-gray-100 dark:bg-gray-800">
            ...
            <div class="h-3/4 flex items-center justify-center">
                <form class="w-full p-2" method="post" action="../src/function/authUserPassword.php">
                    <div class="mb-5">
                        <label for="password" class="block mb-2 text-2xl font-medium text-gray-900 dark:text-white">Palavra-Passe</label>
                        <input type="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500" placeholder="••••••••">
                    </div>
                    <div class="w-full flex items-center justify-center mt-4">
                        <button type="submit" class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-2xl w-15 sm:w-auto px-5 py-2.5 text-center dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">Iniciar Sessão</button>
                    </div>
                </form>
            </div>
        </div>
